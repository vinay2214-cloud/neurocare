...
import BehaviorEventForm from '../../components/caregiver/BehaviorEventForm';
...
export default function LogBehavior() {
  ...
  if (!selectedPatient) {
    return (
      <div className="max-w-lg mx-auto px-4 py-6">
        ...
        <h1 className="text-2xl font-bold text-nc-blue-deep mb-4">Log Behavior Event</h1>
  ...
  return (
    <div className="max-w-lg mx-auto px-4 py-6">
      <button onClick={() => navigate('/caregiver')}
        className="text-nc-blue-mid mb-4 font-bold text-sm">← Back</button>
      <h1 className="text-xl font-bold text-nc-blue-deep mb-1">Log Behavior</h1>
      <p className="text-nc-grey-mid text-sm mb-4">For {selectedPatient.name}</p>
      <BehaviorEventForm patientId={selectedPatient.id}
